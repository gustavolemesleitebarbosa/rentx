...
export function Profile() {
  ...
  async function handleSignOut() {
    Alert.alert('Tem certeza?', 'Lembre-se, que se você sair irá precisar de internet para conectar-se novamente.',
      [{ text: 'não', onPress: () => { }, style: 'cancel' }, { text: 'Sair', onPress: () => { signOut() } }]
    )
  }
          ...
          <Content style={{ marginBottom: useBottomTabBarHeight() }}>
            <Options>
              ...
              <Option active={option === 'passwordEdit'}>
                <OptionTitle onPress={() => handleOptionChange('passwordEdit')} active={option === 'passwordEdit'}>Trocar senha</OptionTitle>
              </Option>
            </Options>
            {
              option === 'dataEdit' ?
